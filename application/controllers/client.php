...
class client extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->load->model("client_model", "dm");
	}
	...
	public function create()
	{
		...
		if($_POST && $this->form_validation->run() === TRUE){
			...
			if($this->dm->save()){
				$this->session->set_userdata('mensagem', array('mensagem' => 'Cliente Salvo com sucesso', 'retorno' => true));
			}else{
				$this->session->set_userdata('mensagem', array('mensagem' => 'Erro ao salvar Cliente', 'retorno' => false));
			}
	...
	public function update($id)
	{
		...
		if($_POST && $this->form_validation->run() === TRUE){
			...
			if($this->dm->save($id)){
				$this->session->set_userdata('mensagem', array('mensagem' => 'Cliente editado com sucesso', 'retorno' => true));
			}else{
				$this->session->set_userdata('mensagem', array('mensagem' => 'Erro ao editar Cliente', 'retorno' => false));
			}
	...
	public function delete($id)
	{
		if($this->dm->change_status($id, '0')){
			$this->session->set_userdata('mensagem', array('mensagem' => 'Cliente inativado com sucesso', 'retorno' => true));
		}else{
			$this->session->set_userdata('mensagem', array('mensagem' => 'Erro ao inativar Cliente', 'retorno' => false));
		}
	...
	public function active($id)
	{
		if($this->dm->change_status($id, '1')){
			$this->session->set_userdata('mensagem', array('mensagem' => 'Cliente ativado com sucesso', 'retorno' => true));
		}else{
			$this->session->set_userdata('mensagem', array('mensagem' => 'Erro ao ativar Cliente', 'retorno' => false));
		}
