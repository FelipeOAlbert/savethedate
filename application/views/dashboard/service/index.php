...
<body>
    ...
    <div class="content">
        ...
        <div id="pad-wrapper" class="users-list">
			...
			<div class="row">
                <h2 class="col-md-10 col-sm-10 col-xs-10">Serviço</h2> 
                    ...
                    <table class="table table-striped table-hover table-bordered table-condensed table-responsive">
                        <thead>
                            <tr>
								...
								<th class="col-md-1">Listar Home</th>
							   ...
							   <tr class="first">
									...
									<td>
										<? if(!empty($row['image'])){ $row['image'] = explode('.', $row['image']);?>
											<img src="<?=site_url('assets/uploads/service/'.$row['image'][0].'_thumb.'.$row['image'][1]);?>" width="190"/>
										<? }else{ ?>
										<p>Sem imagem</p>
										<? } ?>
									</td>
