			...
			<form class="new_user_form" method="post" enctype="multipart/form-data" >
				...
				<div class="col-md-12 field-box">
					...
					<div class="col-md-11 field-box actions">
						<img id="thumb" src="<?=site_url('assets/uploads/banner/'.$row['image'][0].'_thumb.'.$row['image'][1]);?>" />
				...
				<div class="col-md-12 field-box">
					...
					<div class="col-md-8">
						<input class="form-control" type="text" name="link" value="<?=set_value('link', @$row['link'], $this->input->post('link')); ?>" />
					</div>
				</div>
