	...
	<div class="col-md-9 with-sidebar">
		...
		<div class="container">
			...
			<form class="new_user_form" method="post" enctype="multipart/form-data" >
				...
				<div class="col-md-12 field-box">
					<label for="name" class="col-md-2 control-label">Fixar na listagem:</label>
					<div class="col-md-8">
						
						<?
							$check = false;
							if(isset($row['fixed']) and $row['fixed'] == 1){
								$check = true;
						...
						<input  type="checkbox" name="fixed" value='1' <? if($check){ ?> checked="checked" <? } ?>/>
					</div>
				</div>
				...
				<div class="col-md-12 field-box">
					...
					<div class="col-md-11 field-box actions">
						<img id="thumb" src="<?=site_url('assets/uploads/notice/'.$row['image'][0].'_thumb.'.$row['image'][1]);?>" />
