...
<body>
    ...
    <div class="content">
        ...
        <div id="pad-wrapper" class="users-list">
			...
			<div class="row">
                <h2 class="col-md-10 col-sm-10 col-xs-10">Planos</h2> 
                <div class="col-md-2 col-sm-2 col-xs-2">
                     <a href="<?=site_url("plan/create");?>" class="btn btn-success pull-right"><span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;Adicionar</a>
                </div>
            </div>
			<br />
                        ...
                        <tbody>
							...
							<? foreach($list as $row){ ?>
							   ...
							   <tr class="first">
									...
									<td>
										<a href="<?=site_url("plan/update/".$row['id']);?>" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp;Editar</a>
										
										<? if($row['status_id'] == 1){ ?>
											<a href="<?=site_url('plan/delete/'.$row['id']);?>" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Inativar</a>
										<? }else{ ?>
											<a href="<?=site_url('plan/active/'.$row['id']);?>" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Ativar</a>
										<? } ?>
									</td>
							   </tr>
						   <?php }?>
            ...
            <?php }else{ ?>
               <p> Nenhum plano cadastrado, clique no botão acima para adicionar.</p>
            <?php } ?>
